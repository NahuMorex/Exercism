...
"""
face_cards: str = "J, Q, K"
numerical: str = "2,3,4,5,6,7,8,9"
...
def value_of_card(card):
    ...
    """
    if card in face_cards or card == '10':
        return 10
    if card in numerical:
        return int(card)
    if card == 'A':
        return 1
...
def higher_card(card_one, card_two):
    ...
    if value_card_one != "Not valid card" and value_card_two != "Not valid card":
...
def value_of_ace(card_one, card_two):
    ...
    if value_card_one != "Not valid card" and value_card_two != "Not valid card":
        if not ((card_one == 'A') or (card_two == 'A')) and value_card_one + value_card_two <= 10:
            return 11   
        return 1
    return "Not valid card"
...
def is_blackjack(card_one, card_two):
    ...
    if value_card_one != "Not valid card" and value_card_two != "Not valid card":
        return ((card_one == 'A') != (card_two == 'A')) and (value_card_one == 10 or value_card_two == 10)
    return False
